...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can view their own exchange credentials') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can insert their own exchange credentials') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can update their own exchange credentials') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can delete their own exchange credentials') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can view their own exchange configs') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can insert their own exchange configs') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can update their own exchange configs') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can delete their own exchange configs') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can view their own order history') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can insert their own order history') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can update their own order history') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policy WHERE polname = 'Users can delete their own order history') THEN
