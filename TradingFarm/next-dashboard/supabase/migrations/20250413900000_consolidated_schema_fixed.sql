...
-- Drop existing policies for farm_users
DROP POLICY IF EXISTS "Farm members can view farm users" ON public.farm_users;
DROP POLICY IF EXISTS "Farm owners can manage farm users" ON public.farm_users;

-- Create RLS policies for farm_users
...
DROP POLICY IF EXISTS "Farm admins can manage farm agents" ON public.agents;
DROP POLICY IF EXISTS "Allow farm owners to manage agents" ON public.agents;
DROP POLICY IF EXISTS "Allow users to read agents" ON public.agents;
...
-- Drop existing policies for strategies
...
DROP POLICY IF EXISTS "Farm admins can manage farm strategies" ON public.strategies;
DROP POLICY IF EXISTS "Allow users to read strategies" ON public.strategies;
DROP POLICY IF EXISTS "Allow users to create strategies" ON public.strategies;
DROP POLICY IF EXISTS "Allow authenticated users to update strategies" ON public.strategies;
...
DROP POLICY IF EXISTS "Farm admins can manage farm wallets" ON public.wallets;
...
DROP POLICY IF EXISTS "Allow users to read transactions" ON public.transactions;
...
DROP POLICY IF EXISTS "Farm admins can manage farm goals" ON public.goals;
