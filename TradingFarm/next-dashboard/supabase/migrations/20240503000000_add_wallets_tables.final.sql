...
CREATE TRIGGER handle_wallet_balance_history_updated_at
...
-- Create RLS policies for wallets - fixing type mismatch between auth.uid() (UUID) and other ID fields (BIGINT)
