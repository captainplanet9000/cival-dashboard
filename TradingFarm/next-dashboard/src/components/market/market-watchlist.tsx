...
export function MarketWatchlist({ userId, className, onSymbolSelect }: MarketWatchlistProps): React.ReactElement {
  ...
  const handleToggleFavorite = async (item: MarketWatchlistItem): Promise<void> => {
    try {
      const supabase = createBrowserClient();
  ...
  const openEditDialog = (item: MarketWatchlistItem): void => {
    setEditingItem(item);
    setFormValues({
      symbol: item.symbol,
  ...
  const getExchangeBadgeVariant = (exchange: string): "default" | "outline" | "secondary" | "destructive" => {
  ...
  const renderWatchlistItems = (): React.ReactNode => {
    if (loading) {
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormValues({...formValues, symbol: e.target.value})}
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value: string) => setFormValues({...formValues, exchange: value})}
                >
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Textarea
                  ...
                  onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) => setFormValues({...formValues, notes: e.target.value})}
                />
              </div>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <div className="flex items-center space-x-2 col-span-3">
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => setFormValues({...formValues, isFavorite: checked})}
                  />
