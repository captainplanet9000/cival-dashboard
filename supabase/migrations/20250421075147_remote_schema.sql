...
CREATE TABLE IF NOT EXISTS "public"."orders" (
    ...
    "execution_strategy" character varying(20),
...
CREATE INDEX "idx_orders_wallet_id" ON "public"."orders" USING "btree" ("wallet_id");
...
CREATE OR REPLACE TRIGGER "handle_orders_created_at" BEFORE INSERT ON "public"."orders" FOR EACH ROW EXECUTE FUNCTION "public"."handle_created_at"();
...
ALTER TABLE ONLY "public"."orders"
    ADD CONSTRAINT "orders_farm_id_fkey" FOREIGN KEY ("farm_id") REFERENCES "public"."farms"("id") ON DELETE SET NULL;
...
CREATE POLICY "Only authenticated users can access orders" ON "public"."orders" USING (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Service role can do anything" ON "public"."orders" TO "service_role" USING (true);
